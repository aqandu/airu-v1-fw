...
#ifdef PRISMS
    ci->cdata.username.cstring = "sensor";                                      // prisms
    ci->cdata.password.cstring = "GEvTD9NtuY2PwLHTeTaBx8i8DYMbZKa7QXRs6uBj";    // prisms
#else
    ci->cdata.username.cstring = "sensor";                                    // airU
    ci->cdata.password.cstring = "PaG06pSo43oM4Cx";                           // airU
#endif
